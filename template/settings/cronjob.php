<?php
    ...
    $recurrence      = isset( ${NICKLOWER}_crawler_settings['cronjob']['recurrence'] ) ? ${NICKLOWER}_crawler_settings['cronjob']['recurrence'] : '3';
    $number_chapters = isset( ${NICKLOWER}_crawler_settings['cronjob']['number_chapters'] ) ? ${NICKLOWER}_crawler_settings['cronjob']['number_chapters'] : '1';
?>
