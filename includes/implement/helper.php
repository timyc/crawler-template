<?php
    ...
    if( class_exists('WP_CRAWLER_ACTIONS') ){
        ...
        class {NICK}_CRAWLER_HELPERS extends WP_CRAWLER_ACTIONS{
            ...
            public static function update_crawler_settings( $settings ){
                ...
                $options = get_option( '_{NICKLOWER}_crawler_settings', array() );

                return update_option( '_{NICKLOWER}_crawler_settings', array_merge( $options, $settings ) );
