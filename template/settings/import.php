<?php
    ...
    $status = isset( ${NICKLOWER}_crawler_settings['import']['status'] ) ? ${NICKLOWER}_crawler_settings['import']['status'] : 'pending';
    $genres = isset( ${NICKLOWER}_crawler_settings['import']['genres'] ) ? ${NICKLOWER}_crawler_settings['import']['genres'] : array();
    $tags   = isset( ${NICKLOWER}_crawler_settings['import']['tags'] ) ? ${NICKLOWER}_crawler_settings['import']['tags'] : '';
    $storage   = isset( ${NICKLOWER}_crawler_settings['import']['storage'] ) ? ${NICKLOWER}_crawler_settings['import']['storage'] : '';
